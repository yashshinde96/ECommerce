	...
	<section class="arrival_section">
		<div class="container">
			<div class="box">
				...
				<img src="data:image/jpeg;base64,${add.imgUtility}" alt="">
				</c:forEach>
				</div>
				<div class="row">
				...
				<div class="col-md-4">
					<div class="full">
						<div class="logo_footer">
							<a href="#"><img width="210" src='<spring:url value="/images/login-logo.png"/>' alt="#" /></a>
						</div>
						<div class="information_f">
							<p>
								<strong>ADDRESS:</strong> Nanded
							</p>
							<p>
								<strong>TELEPHONE:</strong> +91 9373 429 375
							</p>
							<p>
								<strong>EMAIL:</strong> giftmania@gmail.com
							</p>
						</div>
					</div>
				</div>
